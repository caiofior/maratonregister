CREATE TABLE  IF NOT EXISTS `#__atlete` (
  ...
  `payment_type` enum('bank_transfer','money_order','paypal','other') DEFAULT NULL COMMENT 'Payment type',
  ...
  `group_reference_id` int(11) DEFAULT NULL COMMENT 'ID of group reference',
