CREATE IF NOT EXISTS TABLE `#__atlete` (
  ...
  UNIQUE INDEX `pectoral` (`pectoral` ASC)  COMMENT ' /* comment truncated */ /*Pectola must be unique*/' ,
  UNIQUE INDEX `num_tes` (`num_tes` ASC, `removed` ASC)  COMMENT ' /* comment truncated */ /*Fidal id must be unique*/' ,
